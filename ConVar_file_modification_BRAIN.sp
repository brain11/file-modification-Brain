...
#define PLUGIN_PREFIX "\x04[ConVar file modification BRAIN]\x03 "
...
{
	name = "ConVar file modification BRAIN",	/* https://freedomaction.myarena.site/ */
	author = "BRAIN",
	description = "Disables ConVar output.",
	version = PLUGIN_VERSION,
	url = "https://freedomaction.myarena.site/"
};
